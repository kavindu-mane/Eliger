...
const ManageHNSAccount = ({ isOpenModal, setIsOpenModal, details }) => {
  ...
  return (
    <Modal
      ...
      size={"4xl"}
    >
      <Modal.Header>Manage Help and Support Staff</Modal.Header>
      <Modal.Body className="no-scrollbar">
        <div className="space-y-3">
          <p className="font-Poppins">Driver Name : {details?.name}</p>
...
export default ManageHNSAccount;
