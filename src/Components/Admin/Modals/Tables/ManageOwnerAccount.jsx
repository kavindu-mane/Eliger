...
const ManageOwnerAccount = ({ isOpenModal, setIsOpenModal, details }) => {
  ...
  return (
    <Modal
      ...
      size={"4xl"}
    >
      <Modal.Header>Manage Vehicle Owner</Modal.Header>
      <Modal.Body className="no-scrollbar">
        <div className="space-y-3">
          ...
          <p className="font-Poppins">Phone : {details?.Owner_Tel}</p>
          ...
          <p className="font-Poppins">Address : {details?.Owner_address}</p>
        </div>
      </Modal.Body>
...
export default ManageOwnerAccount;
