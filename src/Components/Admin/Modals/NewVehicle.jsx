...
const NewVehicle = ({ isOpenModal, setIsOpenModal, details }) => {
  ...
  return (
    <Modal
      ...
      size={"4xl"}
    >
      <Modal.Header>New Vehicle Registration</Modal.Header>
      ...
      <Modal.Footer className="flex justify-end">
        ...
        <Button
          className="h-9 rounded-md bg-orange-400 dark:bg-orange-400"
          onClick={() => {
            changeVehicleStatus("pending");
            setIsOpenModal(false);
          }}
        >
          Move To Pending
